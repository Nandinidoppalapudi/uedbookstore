...
const Model = require('../models/addnewbook.js')
...
api.get('/', (req, res) => {
  ...
  Model.find({}, (err, data) => {
    ...
    res.locals.addnewbooks = data
    res.render('addnewbook/index.ejs')
  })
})
...
api.get('/create', (req, res) => {
  ...
  Model.find({}, (err, data) => {
    ...
    res.locals.addnewbooks = data
    res.locals.addnewbook = new Model()
    res.render('addnewbook/create.ejs')
  })
})
...
api.get('/delete/:id', (req, res) => {
  ...
  Model.find({ _id: id }, (err, results) => {
    ...
    res.locals.addnewbook = results[0]
    return res.render('addnewbook/delete.ejs')
  })
})
...
api.get('/details/:id', (req, res) => {
  ...
  Model.find({ _id: id }, (err, results) => {
    ...
    LOG.info(`RETURNING VIEW FOR ${JSON.stringify(results)}`)
    res.locals.addnewbook = results[0]
    return res.render('addnewbook/details.ejs')
  })
})
...
api.get('/edit/:id', (req, res) => {
  ...
  Model.find({ _id: id }, (err, results) => {
    ...
    LOG.info(`RETURNING VIEW FOR${JSON.stringify(results)}`)
    res.locals.addnewbook = results[0]
    return res.render('addnewbook/edit.ejs')
  })
})
...
api.post('/save', (req, res) => {
  ...
  item.save((err) => {
    ...
    return res.redirect('/addnewbook')
  })
})
